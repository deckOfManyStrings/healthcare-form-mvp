...
export function InviteCodeSection({ onSuccess, onBackClick, initialCode }: InviteCodeSectionProps) {
  ...
  const handleCreateAccount = async (values: Omit<InviteCodeForm, 'inviteCode'>) => {
  ...
  const getRoleDescription = (role: string) => {
    switch (role) {
      case 'owner': return 'Full access to manage business, forms, and team'
      case 'manager': return 'Can create and manage forms, view all submissions'
      case 'staff': return 'Can fill out forms and view own submissions'
  ...
  return (
    <Container size={500} my={40}>
      <Stack align="center" gap="lg">
        ...
        <Stack align="center" gap="xs">
          <Title order={1} ta="center">Join Healthcare Team</Title>
              ...
              <form onSubmit={codeForm.onSubmit(handleValidateCode)}>
                <Stack gap="md">
                  <TextInput
                    ...
                    onChange={(event) => codeForm.setFieldValue('code', event.currentTarget.value.toUpperCase())}
                  ...
                  <Text size="sm" c="dimmed" ta="center">
                    Enter the 8-character code you received from your team administrator
                  </Text>
            ...
            <Stack gap="md">
              ...
              <Alert color="green" variant="light" icon={<IconCheck size="1rem" />}>
                <Stack gap="xs">
                  ...
                  <Text size="xs" c="dimmed">{getRoleDescription(validatedCode.role)}</Text>
                </Stack>
              </Alert>
                ...
                <Stack gap="md">
                  ...
                  <Group grow>
                    <TextInput
                      ...
                      onChange={(event) => detailsForm.setFieldValue('firstName', event.currentTarget.value)}
                    ...
                    <TextInput
                      ...
                      onChange={(event) => detailsForm.setFieldValue('lastName', event.currentTarget.value)}
                  ...
                  <TextInput
                    ...
                    onChange={(event) => detailsForm.setFieldValue('email', event.currentTarget.value)}
                  ...
                  <PasswordInput
                    ...
                    onChange={(event) => detailsForm.setFieldValue('password', event.currentTarget.value)}
                  ...
                  <PasswordInput
                    ...
                    onChange={(event) => detailsForm.setFieldValue('confirmPassword', event.currentTarget.value)}
